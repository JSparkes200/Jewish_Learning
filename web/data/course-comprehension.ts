...
export const COMPREHENSION_BY_SECTION: Record<string, ComprehensionPassage> = {
  "2-comp": {
    ...
    questions: [
      ...
      },
      {
        ...
        ans: 1,
        note: "נינוח in this context means at ease, calm, comfortable.",
      },
    ],
  },
  "2-comp-2": {
  ...
  "3-comp": {
    ...
    questions: [
      ...
      {
        q: "In this passage, רַחֲמִים is best translated as:",
        opts: [
          "Mercy / compassion",
          "Strict punishment only",
          "Economic growth",
          "Legal document",
        ],
        ans: 0,
        note: "רַחֲמִים in the passage is one of the ethical values discussed: compassion.",
      },
      {
  ...
  "4-comp": {
    ...
    questions: [
      ...
      {
        q: "In this context, what is a מַאֲמָר דֵּעָה?",
        opts: [
          "An opinion essay/editorial",
          "A legal verdict",
          "A recipe text",
          "A private letter",
        ],
        ans: 0,
        note: "מאמר דעה means an opinion piece/editorial, common in media register.",
      },
      {
